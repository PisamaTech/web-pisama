          ...
          <article className="prose prose-lg mx-auto prose-headings:font-display prose-headings:text-primary-500 prose-p:font-sans ...">
            ...
            <div className="space-y-12">
              <div>
                ...
                <ul>
                  <li>
                    ...
                    <Item
                      original={reagendamientoDashboard.src}
                      width={reagendamientoDashboard.width}
                      height={reagendamientoDashboard.height}
                    >
                      {({ ref, open }) => (
                        <Image
                          ref={
                  ...
                  <li>
                    ...
                    <Item
                      original={reagendamientoReservas.src}
                      width={reagendamientoReservas.width}
                      height={reagendamientoReservas.height}
                    >
                      {({ ref, open }) => (
                        <Image
                          ref={
              ...
              <div>
                ...
                <Item
                  original={reagendamientoModo.src}
                  width={reagendamientoModo.width}
                  height={reagendamientoModo.height}
                >
                  {({ ref, open }) => (
                    <Image
                      ref={
              ...
              <div>
                ...
                <Item
                  original={reagendamientoConfirmar.src}
                  width={reagendamientoConfirmar.width}
                  height={reagendamientoConfirmar.height}
                >
                  {({ ref, open }) => (
                    <Image
                      ref={
            ...
            <div className="not-prose mt-8 grid grid-cols-1 gap-8 md:grid-cols-2">
              <div className="rounded-xl border-2 shadow-xl border-success-300 bg-success-50/50 p-6 hover:scale-105 transition-transform duration-200">
                ...
                <Item
                  original={reagendamientoRevertido.src}
                  width={reagendamientoRevertido.width}
                  height={reagendamientoRevertido.height}
                >
                  {({ ref, open }) => (
                    <Image
                      ref={
              ...
              <div className="rounded-xl border-2 shadow-xl border-danger-300 bg-danger-50/50 p-6 hover:scale-105 transition-transform duration-200">
                ...
                <Item
                  original={reagendamientoPenalizado.src}
                  width={reagendamientoPenalizado.width}
                  height={reagendamientoPenalizado.height}
                >
                  {({ ref, open }) => (
                    <Image
                      ref={
