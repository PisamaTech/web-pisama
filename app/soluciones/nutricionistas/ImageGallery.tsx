...
const ImageGallery = () => {
  // Galería de consultorios disponibles para nutricionistas
  const images = [
    {
      id: 1,
      ...
      width: 1200,
      height: 898,
      alt: "Consultorio 1 - Espacio luminoso y minimalista",
      tag: "Consultorio 1",
    ...
    },
    {
      ...
      width: 1500,
      height: 1129,
      alt: "Consultorio 2 - Ambiente cálido y acogedor",
      tag: "Consultorio 2",
      tagColor: "bg-primary",
    },
    {
      ...
      width: 1500,
      height: 1129,
      alt: "Consultorio 3 - Diseño moderno y profesional",
      tag: "Consultorio 3",
      tagColor: "bg-secondary",
    },
    {
      ...
      width: 1500,
      height: 1122,
      alt: "Consultorio 4 - Espacio clásico y confortable",
      tag: "Consultorio 4",
      tagColor: "bg-primary",
    },
    {
      ...
      width: 1500,
      height: 1122,
      alt: "Consultorio 5 - Ambiente sofisticado",
      tag: "Consultorio 5",
      tagColor: "bg-secondary",
    },
    {
      ...
      width: 1500,
      height: 1122,
      alt: "Consultorio 6 - Carácter único y distintivo",
      tag: "Consultorio 6",
      tagColor: "bg-primary",
    },
  ];
