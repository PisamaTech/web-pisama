          ...
          >
            ...
            <ul>
              <li>
                ...
                consultorios y espacios comunes, así como al uso de la
                Plataforma de reservas proporcionada por Espacio Pisama.
              </li>
              <li>
              ...
              <li>
                <strong>Reserva Eventual:</strong> Una reserva única para un día
                y hora específicos.
              </li>
              <li>
            ...
            <ul>
              ...
              <li>
                ...
                confidencialidad de su contraseña y de toda la actividad que
                ocurra en su cuenta.
              </li>
              <li>
                El uso de la Plataforma está destinado exclusivamente a la
                gestión de reservas para la práctica profesional del Usuario.
              </li>
            </ul>
            ...
            <ul>
              <li>
                ...
                Plataforma y están sujetas a la disponibilidad mostrada en
                tiempo real.
              </li>
              <li>
            ...
            <ul>
              <li>
                ...
                cualquier reserva **sin costo alguno** si lo hace con **más de
                24 horas de antelación** a la hora de inicio de la misma.
              </li>
              <li>
              ...
              <li>
                <strong>Reagendamiento de Horas Penalizadas:</strong> Una
                reserva reserva **sin costo adicional**. Este reagendamiento
                debe &quot;Penalizada&quot; otorga al Usuario el derecho a
                reagendar esa misma realizarse dentro de un plazo de **6 (seis)
                días** a partir de la fecha y hora de la reserva original
                cancelada. Pasado ese plazo, el derecho a reagendamiento se
                pierde.
              </li>
            </ul>
            ...
            <ul>
              <li>
                ...
                Espacio Pisama se reserva el derecho de modificar dichas
                tarifas, notificando a los usuarios con una antelación
                razonable.
              </li>
              <li>
                La facturación se genera de forma automática según la modalidad
                de pago elegida por el Usuario.
              </li>
              <li>
            ...
            <ul>
              <li>
                <strong>Puntualidad:</strong> El Usuario se compromete a
                respetar estrictamente los horarios de inicio y fin de sus
                reservas.
              </li>
              <li>
                <strong>Cuidado del Espacio:</strong> El Usuario es responsable
                de dejar el consultorio en las mismas condiciones de orden y
                limpieza en las que lo encontró.
              </li>
              <li>
            ...
            <ul>
              <li>
                Espacio Pisama no se hace responsable por la práctica
                profesional de los Usuarios, ni por cualquier evento, disputa o
                consecuencia que ocurra entre el Usuario y sus pacientes o
                clientes dentro de las instalaciones.
              </li>
              <li>
                No nos hacemos responsables por la pérdida, daño o robo de
                objetos personales u objetos de trabajo (incluyendo camillas,
                equipos, etc.) que el Usuario ingrese a las instalaciones.
              </li>
            </ul>
            ...
            <p>
              ...
              información. A continuación, te explicamos de forma transparente
              qué datos recopilamos, para qué los usamos y cómo los protegemos.
            </p>
            <ul>
              <li>
                <strong>Qué Datos Recopilamos:</strong> Recopilamos únicamente
                la información necesaria para el funcionamiento del servicio:
                <ul>
                  <li>
                  ...
                  <li>
                    En ningún caso recopilamos ni almacenamos información
                    sensible de tus pacientes.
                  </li>
                </ul>
              </li>
              <li>
                ...
                <ul>
                  ...
                  <li>
                    Procesar la facturación de forma automática y precisa.
                  </li>
                  <li>
              ...
              <li>
                ...
                <ul>
                  ...
                  <li>
                    Utilizamos las prácticas de seguridad estándar de la
                    industria y nos apoyamos en la infraestructura segura de
                    Supabase para proteger tus datos contra accesos no
                    autorizados.
                  </li>
                  <li>
