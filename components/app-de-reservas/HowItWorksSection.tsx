        ...
        <Gallery>
          <div className="grid grid-cols-1 gap-12 md:grid-cols-3">
            ...
            <div className="text-center">
              <Item
                original={aplicacionRegistro.src}
                width={aplicacionRegistro.width}
                height={aplicacionRegistro.height}
              >
                {({ ref, open }) => (
                  <Image
                    ref={
            ...
            <div className="text-center">
              <Item
                original={aplicacionVisualiza.src}
                width={aplicacionVisualiza.width}
                height={aplicacionVisualiza.height}
              >
                {({ ref, open }) => (
                  <Image
                    ref={
            ...
            <div className="text-center">
              <Item
                original={aplicacionConfirma.src}
                width={aplicacionConfirma.width}
                height={aplicacionConfirma.height}
              >
                {({ ref, open }) => (
                  <Image
                    ref={
