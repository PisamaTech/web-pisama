    ...
    <section className="bg-gray-50 py-20 sm:py-24">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="mx-auto mt-16 grid max-w-4xl grid-cols-1 gap-12 md:grid-cols-2">
          ...
          <div className="rounded-2xl bg-content1 border-1 border-content3 p-4 shadow-lg/50 hover:scale-105 transition-transform duration-200 flex flex-col items-center text-center mb-4">
            <div className="mb-2 flex h-20 w-20 items-center justify-center rounded-full bg-primary/10 shadow-sm/50">
